angular.module( 'orderCloud', [
	...
	'orderCloud.adminSalons',
	'orderCloud.avedaSalons',
	...
	//.constant('clientid', 'A0AF90FD-5E07-4A26-A888-0E6A4D389FB0')
	.constant('clientid', '018ddfbd-aff8-413a-8518-f45fc774619b')
	.constant('buyerid', 'AvedaBuyer')
	.constant('ocscope', 'FullAccess')
	.constant('appname', 'AvedaAdmin')
...
function AppCtrl( $state, $scope, $ocMedia ) {
	var vm = this;
	$scope.$on('$stateChangeSuccess', function( event, toState, toParams, fromState, fromParams ){
		if ( angular.isDefined( toState.data.pageTitle ) ) {
			vm.pageTitle = 'AVEDA Admin | ' + toState.data.pageTitle;
		}
	});
	vm.$state = $state;
	vm.$ocMedia = $ocMedia;
